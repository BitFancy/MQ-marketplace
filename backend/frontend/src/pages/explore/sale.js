    ...
    return (
        <>
            ...
            <section className="relative table w-full py-36 bg-[url('../../assets/images/bg/bg1.jpg')] bg-bottom bg-no-repeat">
                ...
                <div className="container">
                    <div className="grid grid-cols-1 pb-8 text-center mt-10">
                        <h3 className="md:text-3xl text-2xl md:leading-snug tracking-wide leading-snug font-medium text-white">NFTs on Sale</h3>
            ...
            <section className="relative md:pb-24 pb-16 -mt-16">
                ...
                <DiscoverItems title={'NFTs on Sale'} pagination={true} showAuction={false} showSale = {true} dataType={dataType} searchString={searchString} rate ={rate}/>
            </section>
            <Footer />
            {/* <Switcher /> */}
        </>
